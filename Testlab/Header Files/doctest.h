...
#define DOCTEST_TYPE_TO_STRING_AS(str, ...)               \
    namespace doctest {                                   \
    template <>                                           \
    inline String toString<__VA_ARGS__>() { return str; } \
    }                                                     \
    static_assert(true, "")
...
struct ConsoleReporter : public IReporter {
    ...
    void printHelp() {
        ...
        // clang-format off
                ...
                s
                        << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "m,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "minimal=<bool>                "
                        << Whitespace(sizePrefixDisplay * 1) << "minimal console output (only failures)\n";
                s
                        << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "q,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "quiet=<bool>                  "
                ...
                s
                        << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "ni,  --" DOCTEST_OPTIONS_PREFIX_DISPLAY "no-intro=<bool>               "
    ...
    void test_run_end(const TestRunStats &p) override {
        ...
        auto totwidth = int(
            std::ceil(log10((std::max(p.numTestCasesPassingFilters,
        ...
        auto failwidth = int(std::ceil(
            log10((std::max(p.numTestCasesFailed,
